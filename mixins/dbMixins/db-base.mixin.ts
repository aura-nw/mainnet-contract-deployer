...
export class DbBaseMixin {
	...
	// eslint-disable-next-line @typescript-eslint/naming-convention
	private getDBUri() {
		console.log(`${this.dbInfo.dialect}://${this.dbInfo.user}:${this.dbInfo.password}@${this.dbInfo.host}:${this.dbInfo.port}/aura_scan_dev`)
		return `${this.dbInfo.dialect}://${this.dbInfo.host}:${this.dbInfo.password}@${this.dbInfo.host}:${this.dbInfo.port}/aura_scan_dev`;
	}
